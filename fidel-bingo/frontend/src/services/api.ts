...
const BASE_URL = import.meta.env.VITE_API_URL || 'https://fidel-bingo.onrender.com/api';
...
export const adminApi = {
  ...
  createUser: (data: { username: string; email: string; password: string; firstName?: string; lastName?: string; phone?: string; role?: string; paymentType?: string; agentId?: string }) =>
    api.post('/users', data),
